...
const Steps = () => {
  return (
    <div className="mt-12 xs:mt-1 md:mt-16 dm:mt-4 flex flex-col items-center mb-24">
        <h1 className="text-xlarge font-poppins font-bold relative after:absolute after:right-0 after:bottom-[4px] after:content-[''] after:w-16 after:h-1 after:rounded-r-sm after:bg-gradient-to-r from-[transparent] via-custom_02 to-brand mb-8">
            Easy to use
        </h1>
