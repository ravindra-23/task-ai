const Features = () => {
  return (
    <div className="mt-12">
        <h1 className="text-xlarge font-poppins font-bold leading-[60px] mb-4 mn:mb-0">
        ...
        >
            <div
                className="border border-brand p-4 flex items-center justify-center 
            ...
            >
                <p className="text-center w-[90%] max-w-[300px]">
                    Task AI helps you accomplish more in less time!
                </p>
            </div>
            <div
                className="border border-brand p-4 flex items-center justify-center 
